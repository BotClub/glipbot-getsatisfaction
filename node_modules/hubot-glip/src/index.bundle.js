...
module.exports = require("glip-client");
...
try {
  ...
  var prequire = __webpack_require__(1);
...
var GlipClient = __webpack_require__(0);
  ...
  _createClass(GlipAdapter, [{
    ...
    value: function login() {
      ...
      this.client.authorize({
        ...
        _this2.robot.logger.info('Logged in.');
        _this2.emit('connected');
        _this2.subscribe();
      }).catch(function (error) {
        _this2.robot.logger.error(`Login failed:`);
        _this2.robot.logger.error(error);
      });
    }
  }, {
    key: 'subscribe',
    value: function subscribe() {
      ...
      this.client.posts().subscribe(function (message) {
        _this3.robot.logger.info(JSON.stringify(message, null, 4));
        var post = message.post || message;
        if ((message.messageType || message.eventType) === 'PostAdded' && post.text && post.text !== '') {
          ...
          _this3.robot.receive(hubotMessage);
        }
      });
    }
  }, {
